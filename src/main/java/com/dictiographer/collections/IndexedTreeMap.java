...
public class IndexedTreeMap<K, V>
        extends com.dictiographer.collections.AbstractMap<K, V>
...
//            System.out.println(e.key + ":" + l + ":" + r + ":" + e.weight);
    ...
    class EntrySet extends com.dictiographer.collections.AbstractSet<Map.Entry<K, V>> {
    ...
    static final class KeySet<E> extends com.dictiographer.collections.AbstractSet<E> implements NavigableSet<E> {
    ...
    static abstract class NavigableSubMap<K, V> extends java.util.AbstractMap<K, V>
        ...
        abstract class EntrySetView extends com.dictiographer.collections.AbstractSet<Entry<K, V>> {
     ...
     * @serial include
     */
    private class SubMap extends com.dictiographer.collections.AbstractMap<K, V>
