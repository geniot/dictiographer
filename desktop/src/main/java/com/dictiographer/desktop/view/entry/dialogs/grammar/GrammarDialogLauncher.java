package com.dictiographer.desktop.view.entry.dialogs.grammar;
...
public class GrammarDialogLauncher {
    ...
    public GrammarDialogLauncher(Window w, Bindable p, Grammar grammar, String cn) {
        try {
            ...
            Class c = Class.forName("com.dictiographer.desktop.view.dialogs.grammar." + lang + ".GrammarDialog" + cn.toUpperCase());
